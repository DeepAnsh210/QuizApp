...
public class QuizQuestion06 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question06);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion06.this, QuizQuestion07.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion06.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion06.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
