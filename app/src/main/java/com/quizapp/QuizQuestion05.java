...
public class QuizQuestion05 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question05);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion05.this, QuizQuestion06.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion05.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion05.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
