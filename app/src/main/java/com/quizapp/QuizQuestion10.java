...
public class QuizQuestion10 extends MyDataClass {
    Button b11;
    Button b12;
    Button b13;
    Button b14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question10);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion10.this, QuizResult.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion10.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion10.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
