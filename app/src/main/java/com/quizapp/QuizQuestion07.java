...
public class QuizQuestion07 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question07);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion07.this, QuizQuestion08.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion07.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion07.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
