...
public class QuizQuestion04 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question04);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion04.this, QuizQuestion05.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion04.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion04.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
