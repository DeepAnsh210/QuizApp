...
public class QuizQuestion02 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question02);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion02.this, QuizQuestion03.class);
    ...
    public void greenColor(View v) {
        ...
        //Toast
        Toast.makeText(QuizQuestion02.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v) {
        ...
        Toast.makeText(QuizQuestion02.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
