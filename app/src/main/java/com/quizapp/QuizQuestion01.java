...
public class QuizQuestion01 extends MyDataClass {
    Button b11;
    Button b12;
    Button b13;
    Button b14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question01);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion01.this, QuizQuestion02.class);
    ...
    public void greenColor(View v){
        ...
        MyDataClass.result=0;
        MyDataClass.result+=1;
        //Toast
        Toast.makeText(QuizQuestion01.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        MyDataClass.result=0;
        Toast.makeText(QuizQuestion01.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
