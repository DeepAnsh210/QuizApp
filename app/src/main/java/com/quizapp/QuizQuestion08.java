...
public class QuizQuestion08 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question08);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion08.this, QuizQuestion09.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion08.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion08.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
