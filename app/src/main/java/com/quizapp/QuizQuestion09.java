...
public class QuizQuestion09 extends MyDataClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_question09);
    ...
    public void openQuizQuestion02() {
        Intent intent = new Intent(QuizQuestion09.this, QuizQuestion10.class);
    ...
    public void greenColor(View v){
        ...
        //Toast
        Toast.makeText(QuizQuestion09.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
    ...
    public void redColor1(View v){
        ...
        Toast.makeText(QuizQuestion09.this, "Incorrect Answer!", Toast.LENGTH_SHORT).show();
        forDelay();
